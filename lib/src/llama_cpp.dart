...
// ignore_for_file: public_member_api_docs, camel_case_types, unused_field, non_constant_identifier_names, unused_element, no_leading_underscores_for_local_identifiers, constant_identifier_names
...
class llama_cpp {
  ...
  late final _ggml_quantize_iq2_xxsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Size Function(
              ...
              ffi.Int,
              ffi.Int,
              ffi.Pointer<ffi.Int64>)>>('ggml_quantize_iq2_xxs');
  late final _ggml_quantize_iq2_xxs = _ggml_quantize_iq2_xxsPtr.asFunction<
      int Function(ffi.Pointer<ffi.Float>, ffi.Pointer<ffi.Void>, int, int,
          ffi.Pointer<ffi.Int64>)>();
  ...
  llm_float_array llm_create_float_array(
    int size,
  ) {
    return _llm_create_float_array(
      size,
    );
  }

  late final _llm_create_float_arrayPtr =
      _lookup<ffi.NativeFunction<llm_float_array Function(ffi.Int)>>(
          'llm_create_float_array');
  late final _llm_create_float_array =
      _llm_create_float_arrayPtr.asFunction<llm_float_array Function(int)>();

  llm_int_array llm_create_int_array(
    int size,
  ) {
    return _llm_create_int_array(
      size,
    );
  }

  late final _llm_create_int_arrayPtr =
      _lookup<ffi.NativeFunction<llm_int_array Function(ffi.Int)>>(
          'llm_create_int_array');
  late final _llm_create_int_array =
      _llm_create_int_arrayPtr.asFunction<llm_int_array Function(int)>();

  llm_inference_parameters llm_create_inference_parameters() {
    return _llm_create_inference_parameters();
  }

  late final _llm_create_inference_parametersPtr =
      _lookup<ffi.NativeFunction<llm_inference_parameters Function()>>(
          'llm_create_inference_parameters');
  late final _llm_create_inference_parameters =
      _llm_create_inference_parametersPtr
          .asFunction<llm_inference_parameters Function()>();

  llm_gpt_params llm_create_gpt_params() {
    return _llm_create_gpt_params();
  }

  late final _llm_create_gpt_paramsPtr =
      _lookup<ffi.NativeFunction<llm_gpt_params Function()>>(
          'llm_create_gpt_params');
  late final _llm_create_gpt_params =
      _llm_create_gpt_paramsPtr.asFunction<llm_gpt_params Function()>();

  llm_float_array llm_embed(
    int llama,
    ffi.Pointer<ffi.Char> text,
  ) {
    return _llm_embed(
  ...
  late final _llm_embedPtr = _lookup<
      ffi.NativeFunction<
          llm_float_array Function(
              ffi.Long, ffi.Pointer<ffi.Char>)>>('llm_embed');
  late final _llm_embed = _llm_embedPtr
      .asFunction<llm_float_array Function(int, ffi.Pointer<ffi.Char>)>();

  llm_int_array llm_encode(
    int llama,
    ffi.Pointer<ffi.Char> text,
  ) {
    return _llm_encode(
  ...
  late final _llm_encodePtr = _lookup<
      ffi.NativeFunction<
          llm_int_array Function(
              ffi.Long, ffi.Pointer<ffi.Char>)>>('llm_encode');
  late final _llm_encode = _llm_encodePtr
      .asFunction<llm_int_array Function(int, ffi.Pointer<ffi.Char>)>();

  int llm_load_model(
    llm_gpt_params parameters,
  ) {
  ...
  late final _llm_load_modelPtr =
      _lookup<ffi.NativeFunction<ffi.Long Function(llm_gpt_params)>>(
          'llm_load_model');
  late final _llm_load_model =
      _llm_load_modelPtr.asFunction<int Function(llm_gpt_params)>();

  void llm_unload_model(
    int llama,
  ) {
    return _llm_unload_model(
      llama,
    );
  }

  late final _llm_unload_modelPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Long)>>(
          'llm_unload_model');
  late final _llm_unload_model =
      _llm_unload_modelPtr.asFunction<void Function(int)>();

  ffi.Pointer<ffi.Char> llm_get_text(
    int llama,
    ffi.Pointer<ffi.Char> prompt,
  ) {
    return _llm_get_text(
      llama,
      prompt,
    );
  }

  late final _llm_get_textPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Long, ffi.Pointer<ffi.Char>)>>('llm_get_text');
  late final _llm_get_text = _llm_get_textPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(int, ffi.Pointer<ffi.Char>)>();

  void llm_set_text_iter(
    int llama,
    ffi.Pointer<ffi.Char> prompt,
  ) {
    return _llm_set_text_iter(
      llama,
      prompt,
    );
  }

  late final _llm_set_text_iterPtr = _lookup<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Long, ffi.Pointer<ffi.Char>)>>(
      'llm_set_text_iter');
  late final _llm_set_text_iter = _llm_set_text_iterPtr
      .asFunction<void Function(int, ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<llm_output> llm_get_next(
    int llama,
  ) {
    return _llm_get_next(
      llama,
    );
  }

  late final _llm_get_nextPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<llm_output> Function(ffi.Long)>>(
          'llm_get_next');
  late final _llm_get_next =
      _llm_get_nextPtr.asFunction<ffi.Pointer<llm_output> Function(int)>();
}
...
abstract class ggml_type {
  ...
  static const int GGML_TYPE_I8 = 17;
  static const int GGML_TYPE_I16 = 18;
  static const int GGML_TYPE_I32 = 19;
  static const int GGML_TYPE_COUNT = 20;
}
...
abstract class ggml_unary_op {
  ...
  static const int GGML_UNARY_OP_COUNT = 10;
}
...
final class llm_inference_parameters extends ffi.Struct {
  @ffi.Int()
  external int n_prev;
  ...
  @ffi.Array.multi([7])
  external ffi.Array<ffi.Char> samplers_sequence;
  ...
  @ffi.Int()
  external int use_penalty_prompt_tokens;
}

final class llm_gpt_params extends ffi.Struct {
  @ffi.UnsignedInt()
  external int seed;
  ...
  external llm_inference_parameters sparams;
  ...
  @ffi.Int()
  external int hellaswag;

  @ffi.UnsignedLong()
  external int hellaswag_tasks;

  @ffi.Int()
  external int mul_mat_q;
  ...
  @ffi.Int()
  external int prompt_cache_all;

  @ffi.Int()
  external int prompt_cache_ro;
  ...
  @ffi.Int()
  external int interactive_first;

  @ffi.Int()
  external int multiline_input;

  @ffi.Int()
  external int simple_io;

  @ffi.Int()
  external int cont_batching;

  @ffi.Int()
  external int input_prefix_bos;
  ...
  @ffi.Int()
  external int verbose_prompt;

  @ffi.Int()
  external int infill;

  @ffi.Int()
  external int dump_kv_cache;

  @ffi.Int()
  external int no_kv_offload;

  @ffi.Array.multi([4])
  external ffi.Array<ffi.Char> cache_type_k;

  @ffi.Array.multi([4])
  external ffi.Array<ffi.Char> cache_type_v;
...
final class llm_output extends ffi.Struct {
  ...
  @ffi.Int()
  external int has_next;
}

final class llm_float_array extends ffi.Struct {
...
final class llm_int_array extends ffi.Struct {
...
final class llm_string_array extends ffi.Struct {
